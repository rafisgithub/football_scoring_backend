        ...
        <div class="owl-4-slider owl-carousel">
          <div class="item">
            <div class="video-media">
              <img src=" {{ asset('landing-page-assets') }} /images/img_1.jpg" alt="Loading" class="img-fluid">
          ...
          <div class="item">
            <div class="video-media">
              <img src=" {{ asset('landing-page-assets') }} /images/img_2.jpg" alt="Loading" class="img-fluid">
              <a href="https://vimeo.com/139714818" class="d-flex play-button align-items-center" data-fancybox>
                <span class="icon mr-3">
                  <span class="icon-play"></span>
                </span>
          ...
          <div class="item">
            <div class="video-media">
              <img src=" {{ asset('landing-page-assets') }} /images/img_3.jpg" alt="Loading" class="img-fluid">
              <a href="https://vimeo.com/139714818" class="d-flex play-button align-items-center" data-fancybox>
                <span class="icon mr-3">
                  <span class="icon-play"></span>
                </span>
