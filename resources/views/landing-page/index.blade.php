...
<head>
    <title>Football &mdash;live scoring app </title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="site-wrap">
        ...
        <div class="hero overlay" style="background-image: url('{{asset('landing-page-assets')}}/images/bg_3.jpg');">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-5 ml-auto">
                        <h3 class="text-white">Bangladesh Local Foot Ball Live Score</h3>
                    ...
                    <div class="d-flex team-vs">
                        ...
                        <div class="team-1 w-50">
                            <div class="team-details w-100 text-center">
                                <img src="{{asset('landing-page-assets')}}/images/logo_1.png" alt="Logo"
                                    class="img-fluid">
                        ...
                        <div class="team-2 w-50">
                            <div class="team-details w-100 text-center">
                                <img src="{{asset('landing-page-assets')}}/images/logo_2.png" alt="Logo"
                                    class="img-fluid">
                ...
                <div class="row no-gutters">
                    <div class="col-md-4">
                        <div class="post-entry">
                            <a href="#">
                                <img src="{{asset('landing-page-assets')}}/images/img_1.jpg" alt="Loading"
                                    class="img-fluid">
                            </a>
                            <div class="caption">
                                <div class="caption-inner">
                                    ...
                                    <div class="author d-flex align-items-center">
                                        <div class="img mb-2 mr-3">
                                            <img src="{{asset('landing-page-assets')}}/images/person_1.jpg" alt="">
                                        </div>
                                        <div class="text">
                    ...
                    <div class="col-md-4">
                        <div class="post-entry">
                            <a href="#">
                                <img src="{{asset('landing-page-assets')}}/images/img_3.jpg" alt="loading"
                                    class="img-fluid">
                            </a>
                            <div class="caption">
                                <div class="caption-inner">
                    ...
                    <div class="col-md-4">
                        <div class="post-entry">
                            <a href="#">
                                <img src="{{asset('landing-page-assets')}}/images/img_2.jpg" alt="loading"
                                    class="img-fluid">
                            </a>
                            <div class="caption">
                                <div class="caption-inner">
                                ...
                                <div class="widget-vs">
                                    <div
                                        ...
                                        <div class="team-1 text-center">
                                            <img src="{{asset('landing-page-assets')}}/images/logo_1.png" alt="loading">
                                        ...
                                        <div class="team-2 text-center">
                                            <img src="{{asset('landing-page-assets')}}/images/logo_2.png" alt="loading">
                                            <h3>Soccer</h3>
                                        </div>
                                    </div>
                                </div>
